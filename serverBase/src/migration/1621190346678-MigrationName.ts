...
export class MigrationName1621190346678 implements MigrationInterface {
    name = 'MigrationName1621190346678'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "provider" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "cel" varchar NOT NULL, "info" varchar NOT NULL, "per_price" decimal NOT NULL, "userId" integer, CONSTRAINT "REL_da1c78142007c621b5498c818c" UNIQUE ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_provider" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "cel" varchar NOT NULL, "info" varchar NOT NULL, "per_price" decimal NOT NULL, "userId" integer, CONSTRAINT "REL_da1c78142007c621b5498c818c" UNIQUE ("userId"), CONSTRAINT "FK_da1c78142007c621b5498c818c1" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);

...
export class MigrationName1621015283266 implements MigrationInterface {
    name = 'MigrationName1621015283266'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "comment" varchar NOT NULL, "provider_id" integer NOT NULL, "price" decimal NOT NULL, "quantity" integer NOT NULL, "date_in" datetime NOT NULL, "userId" integer, "categoryId" integer, "providerId" integer, CONSTRAINT "REL_329b8ae12068b23da547d3b479" UNIQUE ("userId"), CONSTRAINT "REL_ff0c0301a95e517153df97f681" UNIQUE ("categoryId"), CONSTRAINT "REL_f70b268affe05f6e9df0dab57b" UNIQUE ("providerId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "comment" varchar NOT NULL, "provider_id" integer NOT NULL, "price" decimal NOT NULL, "quantity" integer NOT NULL, "date_in" datetime NOT NULL, "userId" integer, "categoryId" integer, "providerId" integer, CONSTRAINT "REL_329b8ae12068b23da547d3b479" UNIQUE ("userId"), CONSTRAINT "REL_ff0c0301a95e517153df97f681" UNIQUE ("categoryId"), CONSTRAINT "REL_f70b268affe05f6e9df0dab57b" UNIQUE ("providerId"), CONSTRAINT "FK_329b8ae12068b23da547d3b4798" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_ff0c0301a95e517153df97f6812" FOREIGN KEY ("categoryId") REFERENCES "category" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_f70b268affe05f6e9df0dab57b0" FOREIGN KEY ("providerId") REFERENCES "provider" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_product"("id", "name", "comment", "provider_id", "price", "quantity", "date_in", "userId", "categoryId", "providerId") SELECT "id", "name", "comment", "provider_id", "price", "quantity", "date_in", "userId", "categoryId", "providerId" FROM "product"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "comment" varchar NOT NULL, "provider_id" integer NOT NULL, "price" decimal NOT NULL, "quantity" integer NOT NULL, "date_in" datetime NOT NULL, "userId" integer, "categoryId" integer, "providerId" integer, CONSTRAINT "REL_329b8ae12068b23da547d3b479" UNIQUE ("userId"), CONSTRAINT "REL_ff0c0301a95e517153df97f681" UNIQUE ("categoryId"), CONSTRAINT "REL_f70b268affe05f6e9df0dab57b" UNIQUE ("providerId"))`);
        await queryRunner.query(`INSERT INTO "product"("id", "name", "comment", "provider_id", "price", "quantity", "date_in", "userId", "categoryId", "providerId") SELECT "id", "name", "comment", "provider_id", "price", "quantity", "date_in", "userId", "categoryId", "providerId" FROM "temporary_product"`);
